...
public class Properties {
  ...
  private static void setVariables() {
    userName = XMLFunctions.getXMLConfiguration(Global.CONFIG_FILE, "addon.username");
    password = XMLFunctions.getXMLConfiguration(Global.CONFIG_FILE, "addon.password");
